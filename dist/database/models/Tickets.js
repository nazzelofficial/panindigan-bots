...
export const TicketPanelModel = (mongoose.models["TicketPanel"] ?? model("TicketPanel", ticketPanelSchema));
export const TicketModel = (mongoose.models["Ticket"] ?? model("Ticket", ticketSchema));
