...
const WelcomeSchema = new Schema({
    ...
    randomMessages: { type: [String], default: [] },
}, { _id: false });
...
const LevelingSchema = new Schema({
    ...
    rewards: {
        type: [
            new Schema({ level: { type: Number, required: true }, roleId: { type: String, required: true } }, { _id: false }),
        ],
        default: [],
    },
}, { _id: false });
...
const guildSchema = new Schema({
    ...
    colorRoles: {
        type: new Schema({ roleIds: { type: [String], default: [] } }, { _id: false }),
        default: () => ({}),
    },
    notificationRoles: {
