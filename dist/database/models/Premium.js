...
export const PremiumModel = (mongoose.models["Premium"] ?? model("Premium", premiumSchema));
export const PremiumCodeModel = (mongoose.models["PremiumCode"] ?? model("PremiumCode", premiumCodeSchema));
export const ServerPackModel = (mongoose.models["ServerPack"] ?? model("ServerPack", serverPackSchema));
export const PriceHistoryModel = (mongoose.models["PriceHistory"] ?? model("PriceHistory", priceHistorySchema));
export const LicenseModel = (mongoose.models["License"] ?? model("License", licenseSchema));
export const BetaFlagModel = (mongoose.models["BetaFlag"] ?? model("BetaFlag", betaFlagSchema));
export const RateLimitExemptModel = (mongoose.models["RateLimitExempt"] ?? model("RateLimitExempt", rateLimitExemptSchema));
