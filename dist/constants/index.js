 ...
 */
// ── Bot identity ──────────────────────────────────────────────────────────────
export const BOT_VERSION = "0.2.6";
export const BOT_NAME = "Panindigan Official";
export const BOT_TAGLINE = "Enterprise-grade Discord Bot for PH communities";
export const BOT_WEBSITE = "https://bot.panindigan.com";
export const BOT_FOOTER = `🤖 ${BOT_NAME}`;
...
// ── Retry / backoff ───────────────────────────────────────────────────────────
export const RETRY = {
    DB_BACKOFF_MS: [1_000, 2_000, 5_000, 10_000, 30_000],
    LAVALINK_BACKOFF_MS: [2_000, 5_000, 10_000, 30_000, 60_000],
    API_BACKOFF_MS: [500, 1_000, 2_000, 5_000],
    MAX_ATTEMPTS: 5,
    JITTER_MAX_MS: 500,
};
// ── Input validation ──────────────────────────────────────────────────────────
...
export const LEVELING = {
    ...
    xpForLevel: (level) => 5 * level ** 2 + 50 * level + 100,
...
export const MUSIC = {
    ...
    AUDIO_FILTERS: ["bassboost", "nightcore", "vaporwave", "8d", "karaoke",
        ...
        "highpass", "soft", "pop", "treble", "earrape"],
};
// ── Moderation ────────────────────────────────────────────────────────────────
export const MODERATION = {
    MAX_PURGE_AMOUNT: 1_000,
    WARN_ESCALATION: { 3: "mute:1h", 5: "kick", 7: "ban" },
    AUDIT_LOG_LIMIT: 100,
