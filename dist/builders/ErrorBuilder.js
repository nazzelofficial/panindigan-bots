...
import { isUserError, isApiError, isDatabaseError, isPanindiganError, PermissionError, CooldownError, PremiumRequiredError, RateLimitError, } from "../lib/errors.js";
// ── Error type meta ───────────────────────────────────────────────────────────
const ERROR_META = {
...
export class ErrorBuilder {
    ...
    resolveMessage() {
        ...
        if (!error)
            return "May nangyaring hindi inaasahang error.";
    ...
    buildButtons(supportUrl) {
        ...
        return new ActionRowBuilder().addComponents(retry, support);
    }
    ...
    static userError(message, fix, opts = {}) {
    ...
    static permissionDenied(action, required, opts = {}) {
        return new ErrorBuilder({
            ...opts,
    ...
    static cooldown(commandName, remainingMs, opts = {}) {
    ...
    static premiumRequired(tier, opts = {}) {
        return new ErrorBuilder({
            ...opts,
