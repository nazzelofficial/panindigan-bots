...
export default {
    data: new SlashCommandBuilder()
        ...
        .setRequired(true)
        .addChoices({ name: 'English', value: 'en' }, { name: 'Tagalog', value: 'tl' }, { name: 'Spanish', value: 'es' }, { name: 'French', value: 'fr' }, { name: 'German', value: 'de' }, { name: 'Japanese', value: 'ja' }, { name: 'Korean', value: 'ko' }, { name: 'Chinese', value: 'zh' })),
    category: 'Owner',
    accessTier: 'owner',
    async execute(interaction) {
        const language = interaction.options.getString('language', true);
        await SystemModel.findOneAndUpdate({}, { defaultLanguage: language }, { upsert: true });
