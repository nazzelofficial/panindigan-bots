...
export default {
    ...
    async execute(interaction) {
        ...
        const prices = system?.serverPackPrices || {
            '3-server': 499,
            '5-server': 799,
            '10-server': 1199
        };
        ...
        const embed = new EmbedBuilder()
            ...
            .setColor('#ffd700')
            .addFields({ name: 'Total Packs', value: totalPacks.toString(), inline: true }, { name: 'Total Servers', value: totalServers.toString(), inline: true }, { name: 'Average Pack Size', value: avgSize.toString(), inline: true }, { name: '3-Server Pack Price', value: `₱${prices['3-server']}`, inline: true }, { name: '5-Server Pack Price', value: `₱${prices['5-server']}`, inline: true }, { name: '10-Server Pack Price', value: `₱${prices['10-server']}`, inline: true }, { name: 'Estimated Revenue', value: `₱${estimatedRevenue.toLocaleString()}`, inline: true })
            .setTimestamp();
        await interaction.reply({ embeds: [embed], ephemeral: true });
    },
};
//# sourceMappingURL=packStats.js.map