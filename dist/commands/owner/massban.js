...
export default {
    ...
    async execute(interaction) {
        ...
        const embed = new EmbedBuilder()
            ...
            .addFields({ name: 'Server', value: `${guild.name} (\`${guild.id}\`)`, inline: true }, { name: 'Requested', value: userIds.length.toString(), inline: true }, { name: 'Banned', value: success.toString(), inline: true }, { name: 'Failed', value: failed.toString(), inline: true }, { name: 'Reason', value: reason, inline: false });
...
//# sourceMappingURL=massban.js.map