...
export default {
    ...
    async execute(interaction) {
        ...
        const embed = new EmbedBuilder()
            ...
            .addFields({ name: 'Server', value: `${guild.name} (\`${guild.id}\`)`, inline: true }, { name: 'Channel', value: channel.name, inline: true }, { name: 'Muted', value: muted.toString(), inline: true }, { name: 'Failed', value: failed.toString(), inline: true }, { name: 'Reason', value: reason, inline: false })
            .setTimestamp()
