...
export default {
    data: new SlashCommandBuilder()
        ...
        .setRequired(true))
        .addStringOption(option => option.setName('phase')
        .setDescription('Rollout phase')
        .setRequired(true)
        .addChoices({ name: 'Alpha', value: 'alpha' }, { name: 'Beta', value: 'beta' }, { name: 'Stable', value: 'stable' })),
    category: 'Owner',
    accessTier: 'owner',
...
//# sourceMappingURL=rolloutEnable.js.map