...
export default {
    data: new SlashCommandBuilder()
        ...
        .setRequired(true)
        .addChoices({ name: 'Playing', value: 'playing' }, { name: 'Watching', value: 'watching' }, { name: 'Listening to', value: 'listening' }, { name: 'Streaming', value: 'streaming' }, { name: 'Competing in', value: 'competing' }))
...
//# sourceMappingURL=botActivity.js.map