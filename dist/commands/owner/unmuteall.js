...
export default {
    ...
    async execute(interaction) {
        ...
        const embed = new EmbedBuilder()
            ...
            .addFields({ name: 'Server', value: `${guild.name} (\`${guild.id}\`)`, inline: true }, { name: 'Channel', value: channel.name, inline: true }, { name: 'Unmuted', value: unmuted.toString(), inline: true }, { name: 'Failed', value: failed.toString(), inline: true })
            .setTimestamp()
