...
export default {
    data: new SlashCommandBuilder()
        ...
        .setRequired(true))
        .addStringOption(option => option.setName('old_server_id')
        .setDescription('Server ID to remove')
        .setRequired(true))
        .addStringOption(option => option.setName('new_server_id')
    ...
    async execute(interaction) {
        ...
        await PremiumModel.findOneAndUpdate({ guildId: oldServerId }, { packId: null });
        await PremiumModel.findOneAndUpdate({ guildId: newServerId }, {
            guildId: newServerId,
            tier: 'enterprise',
            packId,
            grantedAt: new Date(),
...
//# sourceMappingURL=packSwapserver.js.map