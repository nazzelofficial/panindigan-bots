...
export default {
    data: new SlashCommandBuilder()
        ...
        .setRequired(true))
        .addStringOption(option => option.setName('from_channel')
        .setDescription('Source voice channel ID')
        .setRequired(true))
        .addStringOption(option => option.setName('to_channel')
    ...
    async execute(interaction) {
        ...
        const embed = new EmbedBuilder()
            ...
            .addFields({ name: 'Server', value: `${guild.name} (\`${guild.id}\`)`, inline: true }, { name: 'From', value: fromChannel.name, inline: true }, { name: 'To', value: toChannel.name, inline: true }, { name: 'Moved', value: moved.toString(), inline: true }, { name: 'Failed', value: failed.toString(), inline: true })
            .setTimestamp()
