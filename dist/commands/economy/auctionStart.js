...
const command = {
    ...
    async execute(ctx) {
        ...
        const embed = baseEmbed("primary")
            ...
            .addFields({ name: "📦 Item", value: item, inline: true }, { name: "💰 Starting Bid", value: `🪙 ${startingBid.toLocaleString()}`, inline: true }, { name: "⏰ Ends", value: `<t:${Math.floor(endsAt.getTime() / 1000)}:R>`, inline: true })
...
//# sourceMappingURL=auctionStart.js.map