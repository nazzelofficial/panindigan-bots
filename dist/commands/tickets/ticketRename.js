...
const command = {
    ...
    cooldown: 10,
    slashData: (b) => b.addStringOption((o) => o.setName("name").setDescription("New name for the ticket channel").setRequired(true).setMaxLength(50)),
    async execute(ctx) {
        ...
        if (!newName) {
            await ctx.reply({ embeds: [errorEmbed("Please provide a new name.")] });
            return;
        }
...
//# sourceMappingURL=ticketRename.js.map