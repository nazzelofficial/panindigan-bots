...
export default {
    data: new SlashCommandBuilder()
        ...
        .setRequired(true)
        .addChoices({ name: '🎧 Lo-Fi Hip Hop', value: 'lofi' }, { name: '🎺 Jazz24', value: 'jazz' }, { name: '🎻 Classic FM', value: 'classical' }, { name: '📻 1.FM Top 40', value: 'pop' }, { name: '🎸 Radio Paradise Rock', value: 'rock' }, { name: '⚡ EDM / Trance', value: 'edm' }, { name: '🎤 R&B / Soul', value: 'rnb' }, { name: '🤠 Country', value: 'country' }, { name: '🎵 Hip Hop', value: 'hiphop' }, { name: '📰 BBC World Service', value: 'news' }, { name: '🔗 Custom URL', value: 'custom' })),
    category: 'Music',
    accessTier: 'user',
    async execute(interaction) {
        ...
        if (client.lavalink) {
            ...
            const result = await player.search({ query: station.url, source: 'http' }, interaction.client.user).catch(() => null);
            ...
            const embed = new EmbedBuilder()
                ...
                .setColor('#5865F2')
                .addFields({ name: '🎵 Station', value: station.name, inline: true }, { name: '🎼 Genre', value: station.genre, inline: true }, { name: '🔊 Voice Channel', value: `<#${voiceChannelId}>`, inline: true })
