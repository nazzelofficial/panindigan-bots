...
const command = {
    ...
    slashData: (b) => b
        .addUserOption((o) => o.setName("user").setDescription("User whose notes to clear").setRequired(true)),
    async execute(ctx) {
        ...
        await sendLogEvent(guild.id, "noteClear", () => baseEmbed("warning")
...
//# sourceMappingURL=noteclear.js.map