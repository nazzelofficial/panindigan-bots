...
const command = {
    ...
    slashData: (b) => b
        ...
        .addNumberOption(o => o.setName('target').setDescription('Auto cash-out multiplier (e.g. 2.0 for 2×)').setRequired(true).setMinValue(1.01).setMaxValue(100)),
    async execute(ctx) {
        ...
        const embed = new EmbedBuilder()
            ...
            .addFields({ name: '🎯 Your Target', value: `${target.toFixed(2)}×`, inline: true }, { name: '💥 Crash Point', value: `${crashPoint.toFixed(2)}×`, inline: true }, { name: '💰 Payout', value: won ? `+${(payout - bet).toLocaleString()} coins` : `-${bet.toLocaleString()} coins`, inline: true })
