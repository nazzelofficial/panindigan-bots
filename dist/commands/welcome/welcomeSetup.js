...
const command = {
    ...
    async execute(ctx) {
        ...
        await GuildModel.findOneAndUpdate({ guildId: guild.id }, { $set: { "welcome.channelId": channelId, "welcome.enabled": true, ...(msg ? { "welcome.message": msg } : {}) } }, { upsert: true });
...
//# sourceMappingURL=welcomeSetup.js.map