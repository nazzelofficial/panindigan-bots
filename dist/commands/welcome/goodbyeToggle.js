...
const command = {
    ...
    async execute(ctx) {
        ...
        if (enabled && !cfg?.goodbye?.channelId) {
            await ctx.reply({ embeds: [errorEmbed("Set a goodbye channel first using `goodbyechannel` or `goodbyesetup`.")] });
            return;
        }
...
//# sourceMappingURL=goodbyeToggle.js.map