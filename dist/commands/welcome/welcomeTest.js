...
export default {
    data: new SlashCommandBuilder()
        ...
        .addUserOption(o => o.setName('user').setDescription('Simulate welcome for this user (default: yourself)').setRequired(false)),
    category: 'Welcome',
    accessTier: 'admin',
    async execute(interaction) {
        ...
        if (welcome.embedEnabled) {
            ...
            if (welcome.embedFooter)
                embed.setFooter({ text: interpolate(welcome.embedFooter) });
