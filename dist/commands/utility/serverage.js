...
export default {
    ...
    async execute(interaction) {
        ...
        const embed = new EmbedBuilder()
            ...
            .addFields({ name: 'Created', value: created?.toLocaleDateString() || 'Unknown', inline: true }, { name: 'Days Old', value: age.toString(), inline: true })
            .setTimestamp();
        await interaction.reply({ embeds: [embed], ephemeral: true });
    },
};
//# sourceMappingURL=serverage.js.map