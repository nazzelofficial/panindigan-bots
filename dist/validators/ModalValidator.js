...
export class ModalValidator {
    ...
    requireInt(customId, min, max) {
        ...
        if (n < min || n > max) {
            throw new ValidationError(`${customId} must be between ${min} and ${max}`, customId, { value: n, min, max });
        }
        return n;
    }
    /**
...
//# sourceMappingURL=ModalValidator.js.map