...
export const ENV_SCHEMA: EnvSchemaEntry[] = [
  ...
  { key: "GROQ_API_KEY",        required: false, description: "Groq API key (AI features)" },
  { key: "AI_MODEL",            required: false, description: "AI model to use (default: llama-3.3-70b-versatile)" },
