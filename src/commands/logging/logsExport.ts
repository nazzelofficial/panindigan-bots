...
const command: CommandDefinition = {
  ...
  slashData: (b) =>
    (b as SlashCommandBuilder)
      ...
      .addUserOption((o) =>
        o.setName("user").setDescription("Filter logs by user (optional)").setRequired(false),
      )
      .addIntegerOption((o) =>
        o
          .setName("limit")
  ...
  async execute(ctx) {
    ...
    const filter: any = { guildId: guild.id };
    ...
    const embed = baseEmbed("success")
      ...
      .addFields(
        ...
        { name: "Entries", value: cases.length.toString(), inline: true },
