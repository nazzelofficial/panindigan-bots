  ...
  async execute(interaction: ChatInputCommandInteraction) {
    ...
    const embed = new EmbedBuilder()
      ...
      .addFields(
        ...
        { name: 'Total Boosts', value: premiumSubscriptions.toString(), inline: true },
        { name: 'Next Level', value: premiumTier < 3 ? `${(2 ** premiumTier) * 2 - premiumSubscriptions} more needed` : 'Max level', inline: true }
      )
      .setTimestamp();
