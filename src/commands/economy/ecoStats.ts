...
const command: CommandDefinition = {
  ...
  async execute(ctx) {
    ...
    let richestUserId: string | null = null;
    let totalUsers = 0;
    ...
    const embed = baseEmbed("primary")
      ...
      .addFields(
        ...
        { name: "Total Coins in Circulation", value: `🪙 ${totalBalance.toLocaleString()}`, inline: true },
        { name: "Richest User", value: richestUserId ? `<@${richestUserId}>` : "None", inline: true }
      );
