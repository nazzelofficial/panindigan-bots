...
const command: CommandDefinition = {
  ...
  slashData: (b) =>
    (b as SlashCommandBuilder)
      ...
      .addStringOption((o) =>
        o.setName("method").setDescription("Verification method (default: button)").setRequired(false)
          .addChoices(
  ...
  async execute(ctx) {
    ...
    if (!channelId || !roleId) { await ctx.reply({ embeds: [errorEmbed("Please specify both a channel and a role.")] }); return; }
