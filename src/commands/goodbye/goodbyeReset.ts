...
const command: CommandDefinition = {
  ...
  async execute(ctx) {
    ...
    const confirmRow = new ActionRowBuilder<ButtonBuilder>().addComponents(
      new ButtonBuilder().setCustomId("goodbye_reset_confirm").setLabel("Confirm Reset").setStyle(ButtonStyle.Danger),
      new ButtonBuilder().setCustomId("goodbye_reset_cancel").setLabel("Cancel").setStyle(ButtonStyle.Secondary),
    );
