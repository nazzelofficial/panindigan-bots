...
const command: CommandDefinition = {
  ...
  slashData: (b) =>
    (b as SlashCommandBuilder)
      .addStringOption((o) =>
        o.setName("language").setDescription("Preferred AI response language").setRequired(true)
  ...
  async execute(ctx) {
    ...
    if (!lang) { await ctx.reply({ embeds: [errorEmbed("Please provide a language code.")] }); return; }
