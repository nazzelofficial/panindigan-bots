  ...
  slashData: (b) =>
    (b as SlashCommandBuilder)
      ...
      .addStringOption((o) => o.setName("style").setDescription("Visual style").setRequired(false)
        .addChoices(
          { name: "Photorealistic", value: "photorealistic, 8K, high detail" },
          { name: "Cartoon", value: "cartoon style, colorful" },
          { name: "Sketch", value: "pencil sketch, black and white" },
          { name: "Cinematic", value: "cinematic shot, dramatic lighting" },
