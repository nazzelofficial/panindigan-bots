...
export default {
  ...
  async execute(interaction: ChatInputCommandInteraction) {
    ...
    const embed = new EmbedBuilder()
      ...
      .setColor('#ffd700')
      .addFields(
        { name: 'Single-Server Plans', value: '━━━━━━━━━━━━━━━━', inline: false },
        { name: 'Basic', value: `₱${prices.basic}`, inline: true },
        { name: 'Standard', value: `₱${prices.standard}`, inline: true },
        { name: 'Gold', value: `₱${prices.gold}`, inline: true },
        { name: 'Enterprise', value: `₱${prices.enterprise}`, inline: true },
        { name: 'Server Packs', value: '━━━━━━━━━━━━━━━━', inline: false },
