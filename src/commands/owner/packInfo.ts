...
export default {
  ...
  async execute(interaction: ChatInputCommandInteraction) {
    ...
    const embed = new EmbedBuilder()
      ...
      .setColor('#ffd700')
      .addFields(
        { name: 'Servers Count', value: premiums.length.toString(), inline: true },
        { name: 'Tier', value: 'Enterprise', inline: true },
        { name: 'Created At', value: (premiums[0] as any).grantedAt?.toLocaleDateString() || 'Unknown', inline: true }
      )
