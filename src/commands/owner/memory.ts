  ...
  async execute(interaction: ChatInputCommandInteraction) {
    ...
    const embed = new EmbedBuilder()
      ...
      .addFields(
        ...
        { name: 'External', value: `${(memoryUsage.external / 1024 / 1024).toFixed(2)} MB`, inline: true },
        { name: 'RSS', value: `${(memoryUsage.rss / 1024 / 1024).toFixed(2)} MB`, inline: true },
        { name: 'Array Buffers', value: `${(memoryUsage.arrayBuffers / 1024 / 1024).toFixed(2)} MB`, inline: true }
      )
      .setTimestamp();
