...
export const GiveawayModel = ((mongoose.models["Giveaway"] as any) ?? model("Giveaway", giveawaySchema));
export const BirthdayModel = ((mongoose.models["Birthday"] as any) ?? model("Birthday", birthdaySchema));
export const SuggestionModel = ((mongoose.models["Suggestion"] as any) ?? model("Suggestion", suggestionSchema));
export const ServerBackupModel = ((mongoose.models["ServerBackup"] as any) ?? model("ServerBackup", serverBackupSchema));
export const ServerTemplateModel = ((mongoose.models["ServerTemplate"] as any) ?? model("ServerTemplate", serverTemplateSchema));
export const AnnouncementTemplateModel = ((mongoose.models["AnnouncementTemplate"] as any) ?? model("AnnouncementTemplate", announcementTemplateSchema));
export const SavedQueueModel = ((mongoose.models["SavedQueue"] as any) ?? model("SavedQueue", savedQueueSchema));
export const ReactionRoleModel = ((mongoose.models["ReactionRole"] as any) ?? model("ReactionRole", reactionRoleSchema));
export const ButtonRolePanelModel = ((mongoose.models["ButtonRolePanel"] as any) ?? model("ButtonRolePanel", buttonRolePanelSchema));
export const SelectRolePanelModel = ((mongoose.models["SelectRolePanel"] as any) ?? model("SelectRolePanel", selectRolePanelSchema));
export const ColorRoleModel = ((mongoose.models["ColorRole"] as any) ?? model("ColorRole", colorRoleSchema));
export const StarboardModel = ((mongoose.models["Starboard"] as any) ?? model("Starboard", starboardSchema));
export const PollModel = ((mongoose.models["Poll"] as any) ?? model("Poll", pollSchema));
export const TempRoleModel = ((mongoose.models["TempRole"] as any) ?? model("TempRole", tempRoleSchema));
export const ServerStatsModel = ((mongoose.models["ServerStats"] as any) ?? model("ServerStats", serverStatsSchema));
export const InviteTrackingModel = ((mongoose.models["InviteTracking"] as any) ?? model("InviteTracking", inviteTrackingSchema));
