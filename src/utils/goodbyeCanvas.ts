...
export interface GoodbyeCanvasOptions {
  user: User;
  guild: Guild;
  memberCount: number;
  theme?: "default" | "farewell" | "dark" | "red-accent";
  backgroundUrl?: string | null;
  borderRadius?: number;
  blur?: number;
}

export async function generateGoodbyeCanvas(options: GoodbyeCanvasOptions): Promise<Buffer> {
